...
public class KafkaConfig {
    ...
    public ReplyingKafkaTemplate<String, Message, Message> replyingKafkaTemplate(
        ...
        ConcurrentMessageListenerContainer<String, Message> replyContainer = factory.createContainer("v2.kafka.reply");
    ...
    public NewTopic kafkaMessage() {
        return TopicBuilder.name("v2.kafka.message")
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic kafkaReply() {
        return TopicBuilder.name("v2.kafka.reply")
                .partitions(1)
                .replicas(1)
                .build();
    }
